...
export const INSTANCE_STRIDE = floatByteSize(FLOAT_COUNT);
...
export function getInstanceBufferLayout(): GPUVertexBufferLayout {
  return {
    ...
    attributes: [
      {
        shaderLocation: 6,
        offset: floatByteSize(OFFSET_MATRIX_ROW0),
        format: "float32x4",
      },
      {
        shaderLocation: 7,
        offset: floatByteSize(OFFSET_MATRIX_ROW1),
        format: "float32x4",
      },
      {
        shaderLocation: 8,
        offset: floatByteSize(OFFSET_MATRIX_ROW2),
        format: "float32x4",
      },
      {
        shaderLocation: 9,
        offset: floatByteSize(OFFSET_MATRIX_ROW3),
        format: "float32x4",
      },
      {
        shaderLocation: 10,
      ...
      {
        shaderLocation: 11,
        offset: floatByteSize(OFFSET_CUSTOM_DATA0),
        format: "float32x4",
      },
      {
        shaderLocation: 12,
        offset: floatByteSize(OFFSET_CUSTOM_DATA1),
        format: "float32x4",
      },
    ],
  };
