use engine_data::{assets::image::Image, errors::EngineDataError};
...
pub struct TextureAtlas {
    ...
    pub atlas_regions_handle: ResourceHandle,
}

impl TextureAtlas {
    pub fn new_from_image_handle(image_handle: &ResourceHandle, atlas_regions_handle: &ResourceHandle) -> Result<Self, EngineDataError> {
        Ok(Self {
            image_handle: image_handle.clone(),
            view: None,
            atlas_regions_handle: atlas_regions_handle.clone(),
        })
    }
